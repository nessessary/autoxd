...
def hq(code):
    """输出当前的即时行情, 用tushare
    return: 'a3_p,a3_v,a2_p,a2_v,a1_p,a1_v,bid,volume,b1_p,b1_v,b2_p,b2_v,b3_p,b3_v'
    """
    import tushare as ts
    #import stock_pinyin as jx
    #code = jx.KYWL
    try:
        ...
        return None
    #print(df)
    cols = 'a3_p,a3_v,a2_p,a2_v,a1_p,a1_v,bid,volume,b1_p,b1_v,b2_p,b2_v,b3_p,b3_v'
    cols = cols.split(',')
    v= []
    for col in cols:
        v.append(df[col][0])
