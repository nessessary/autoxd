...
"""关于boll分仓策略的实现, 注意这是默认策略， 安装或升级会覆盖该文件
"""
import qjjy
import pd_help
...
def Run(codes, task_id=0):
    ...
    backtest_policy.test_strategy(codes, Strategy_Boll_Pre, setParams, day_num=50,
                                  start_day='2017-8-1', end_day='2017-9-20'
...
class mytest(unittest.TestCase):
	...
	codes = stock.get_codes(stock.myenum.randn, 5)
	cpu_num = 5
	agl.startDebug()
	if agl.IsDebug():
	    codes = [codes[0]]
